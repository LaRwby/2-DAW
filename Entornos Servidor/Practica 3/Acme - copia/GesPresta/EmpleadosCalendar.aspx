              ...
              <div class="fila">
               ...
               <div class="fila">
                ...
                <div class="formato">
                    ...
                    <asp:Calendar ID="Calendar1" runat="server" style="margin-left: 393px" ></asp:Calendar>
                </div>
                <div class="formato2">
                    <asp:Calendar ID="Calendar2" runat="server" style="margin-left: 389px" ></asp:Calendar>
                </div>
    </form>
