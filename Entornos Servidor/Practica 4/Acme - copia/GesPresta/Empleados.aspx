             ...
             <div class="tablagen">
              <div class="fila">
                ...
                <div class="col2"><asp:TextBox ID="txtCodEmp" runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rqdtxtCodEmp" runat="server" ControlToValidate="txtCodEmp" ErrorMessage="El Codigo de Empleado es obligatorio"></asp:RequiredFieldValidator>
                  </div>
              </div>
              <div class="fila">
