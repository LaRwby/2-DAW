...
namespace Lockser.Controllers
{
    public class PedidosController : Controller
    {
        ...
        public PedidosController(LockserContexto context)
        {
            _context = context;
        }
        ...
        {
            var lockserContexto = _context.Pedidos.Include(p => p.Cliente).Include(p => p.Estado);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LockserContexto.Pedidos'  is null.");
            }
            var pedido = await _context.Pedidos.FindAsync(id);
            if (pedido != null)
            {
